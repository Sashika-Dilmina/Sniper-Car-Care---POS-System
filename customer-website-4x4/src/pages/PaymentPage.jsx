    ...
    useEffect(() => {
        if (stripe && order) {
            const pr = stripe.paymentRequest({
                ...
                currency: 'aed',
                total: {
                    label: `Order #${order.id} - Sniper Car Care (4x4)`,
        ...
        <div className="min-h-screen bg-gray-900 text-white selection:bg-yellow-500/30">
            <div className="max-w-2xl mx-auto px-6 py-12">
                <div className="text-center mb-12">
                    <h1 className="text-5xl font-black mb-4 bg-gradient-to-r from-white to-gray-500 bg-clip-text text-transparent italic tracking-tighter">4x4 CHECKOUT</h1>
                ...
                <div className="glassmorphism rounded-3xl overflow-hidden border border-gray-800 shadow-2xl mb-8">
                    <div className="p-8 bg-gradient-to-br from-gray-800/80 to-transparent">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <p className="text-sm text-yellow-500 font-black uppercase tracking-widest mb-1">Vehicle Plate (4x4)</p>
