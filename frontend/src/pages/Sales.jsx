...
const Sales = () => {
  ...
  const handleWhatsAppShare = () => {
    const message = `*Sniper Car Care - Daily Sales Statement*\n` +
      ...
      `*Total Discounts:* AED ${totalDiscount.toFixed(2)}\n` +
      `*Grand Total Revenue:* AED ${totalRevenue.toFixed(2)}\n\n` +
      `Generated by Sniper POS Admin Ledger.`;
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 rounded-2xl border shadow-sm no-print">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl shadow-md transition flex items-center gap-2 text-sm"
              >
                💬 Share via WhatsApp
              </button>
              <button
