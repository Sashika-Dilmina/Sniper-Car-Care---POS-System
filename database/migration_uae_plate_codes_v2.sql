-- Database Migration: UAE Plate Codes Seed v2
USE sniper_car_care;

-- 1. Wipe current plate codes
DELETE FROM PlateCodeMaster;

-- 2. Seed Emirates & new Plate Codes to PlateCodeMaster
INSERT INTO PlateCodeMaster (EmirateId, EmirateName, PlateCode) VALUES
-- Dubai (Id = 2)
(2, 'Dubai', 'A'), (2, 'Dubai', 'AA'), (2, 'Dubai', 'B'), (2, 'Dubai', 'BB'), (2, 'Dubai', 'C'), 
(2, 'Dubai', 'CC'), (2, 'Dubai', 'D'), (2, 'Dubai', 'DD'), (2, 'Dubai', 'E'), (2, 'Dubai', 'EE'), 
(2, 'Dubai', 'F'), (2, 'Dubai', 'FF'), (2, 'Dubai', 'G'), (2, 'Dubai', 'H'), (2, 'Dubai', 'HH'), 
(2, 'Dubai', 'I'), (2, 'Dubai', 'III'), (2, 'Dubai', 'J'), (2, 'Dubai', 'K'), (2, 'Dubai', 'L'), 
(2, 'Dubai', 'M'), (2, 'Dubai', 'N'), (2, 'Dubai', 'NN'), (2, 'Dubai', 'O'), (2, 'Dubai', 'P'), 
(2, 'Dubai', 'Q'), (2, 'Dubai', 'R'), (2, 'Dubai', 'S'), (2, 'Dubai', 'T'), (2, 'Dubai', 'U'), 
(2, 'Dubai', 'V'), (2, 'Dubai', 'W'), (2, 'Dubai', 'X'), (2, 'Dubai', 'Y'), (2, 'Dubai', 'Z'), 
(2, 'Dubai', 'Classic Code'), (2, 'Dubai', 'Motorcycle 1'), (2, 'Dubai', 'Motorcycle 2'), 
(2, 'Dubai', 'Motorcycle 3'), (2, 'Dubai', 'White'),
...
(6, 'Ras Al Khaimah', 'Z'), (6, 'Ras Al Khaimah', 'UA'), (6, 'Ras Al Khaimah', 'White'),

-- Fujairah (Id = 7)
(7, 'Fujairah', '1'), (7, 'Fujairah', '2'), (7, 'Fujairah', '3'), (7, 'Fujairah', '4'), (7, 'Fujairah', 'A'), 
(7, 'Fujairah', 'B'), (7, 'Fujairah', 'C'), (7, 'Fujairah', 'D'), (7, 'Fujairah', 'E'), (7, 'Fujairah', 'F'), 
(7, 'Fujairah', 'G'), (7, 'Fujairah', 'H'), (7, 'Fujairah', 'I'), (7, 'Fujairah', 'J'), (7, 'Fujairah', 'K'), 
(7, 'Fujairah', 'L'), (7, 'Fujairah', 'M'), (7, 'Fujairah', 'N'), (7, 'Fujairah', 'O'), (7, 'Fujairah', 'P'), 
(7, 'Fujairah', 'Q'), (7, 'Fujairah', 'R'), (7, 'Fujairah', 'S'), (7, 'Fujairah', 'T'), (7, 'Fujairah', 'U'), 
(7, 'Fujairah', 'V'), (7, 'Fujairah', 'W'), (7, 'Fujairah', 'X'), (7, 'Fujairah', 'Y'), (7, 'Fujairah', 'Z'), 
(7, 'Fujairah', 'Classic'), (7, 'Fujairah', 'The Tour'), (7, 'Fujairah', 'White');
