...
const packages = [
  {
    ...
    features: ['Interior deep cleaning', 'Exterior foam wash', 'Wheel cleaning'],
    duration: '90 minutes',
  },
  {
    name: 'Double Soap',
    ...
    features: ['Double foam wash', 'Hand wash', 'Wheel cleaning'],
    duration: '60 minutes',
  },
  {
    name: 'Ceramic Wash',
            ...
            <form onSubmit={submitVIPBooking} className="space-y-4">
              <div>
                ...
                <div className="w-full px-4 py-3 rounded-lg bg-gray-100 border border-gray-200 text-gray-900 font-semibold flex justify-between items-center">
                  <span>Saloon VIP Service</span>
                  <span className="text-red-600">75 AED</span>
                </div>
              </div>
              <div>
